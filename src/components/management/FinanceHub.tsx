...
import { BankAccountsManager } from "@/components/management/BankAccountsManager";
...
import { Wallet, ArrowLeftRight, Percent, Bot, FolderTree, BarChart3, Landmark } from "lucide-react";
  ...
  return (
    <Tabs defaultValue="categorized" className="space-y-4">
      <TabsList className="flex-wrap h-auto">
        ...
        <TabsTrigger value="banks" className="gap-1"><Landmark className="h-3.5 w-3.5" />Contas Bancárias</TabsTrigger>
