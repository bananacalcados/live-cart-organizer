...
export function TeamChat() {
  ...
  const shouldHide = p === '/login' || p === '/pos' || p === '/expedition' || p.startsWith('/expedition') || p === '/live' || p === '/live-consumidor' || p.startsWith('/live-ortopedicos') || p.startsWith('/banana-') || p.startsWith('/lp/') || p.startsWith('/cat/') || p.startsWith('/evento/') || p.startsWith('/checkout') || p.startsWith('/checkout-loja/') || p.startsWith('/vip/') || p.startsWith('/dose-tripla') || p.startsWith('/catalogo/') || p.startsWith('/l/') || p.startsWith('/register/') || p.startsWith('/live/') || p.startsWith('/typebot/') || p.startsWith('/r/') || p.startsWith('/minha-area');
