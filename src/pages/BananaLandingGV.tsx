...
const VIP_GROUP_LINK = "https://i.sendflow.pro/l/O6HavFl1ylTE3094cHaZ";
    ...
    <div className="flex flex-col items-center text-center gap-4 flex-1 justify-center">
      ...
      <div>
        ...
        <p className="text-sm text-gray-600 mt-2 leading-relaxed">
          Você está dentro do nosso <strong>Grupo VIP de GV</strong>! 🥳
        </p>
        <p className="text-sm text-gray-500 mt-2 leading-relaxed">
          O grupo estará em modo silencioso até o dia do evento. Nos dias <strong>19, 20 e 21</strong> vamos abrir pra você participar e garantir suas ofertas! 🔥
        </p>
      </div>
      <a
        href={VIP_GROUP_LINK}
...
export default function BananaLandingGV() {
  ...
  return (
    ...
    >
                ...
                <div>
                  ...
                  <div className="mt-3 bg-emerald-50 rounded-xl p-3">
                    <p className="text-xs font-semibold text-emerald-700">
                      📍 Visite nossas lojas em Gov. Valadares:
                    </p>
                    <p className="text-xs text-emerald-600 mt-1">
                      🏬 <strong>Centro</strong> &nbsp;•&nbsp; 🏬 <strong>Jardim Pérola</strong>
                    </p>
                  </div>
                </div>
                <button
            ...
            {step === "whatsapp" && (
              <div className="flex flex-col gap-4 flex-1 justify-center">
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    Pra te adicionar no Grupo VIP de GV
                  </p>
                </div>
                <input
                  ref={inputRef}
      ...
      <p className="text-white/50 text-xs mt-6 relative z-10">
        © 2025 Banana Calçados — Gov. Valadares, MG
      </p>
    </div>
  );
}
