-- Update existing empty Instagram messages to show placeholder
UPDATE whatsapp_messages 
SET message = '[mensagem anterior]'
WHERE channel = 'instagram' 
  AND (message IS NULL OR message = '')
  AND direction = 'incoming';

-- Update get_conversations to also return sender_name
...
BEGIN
  ...
  -- Get the most recent sender_name for each phone (for Instagram/Messenger contacts)
  contact_names AS (
