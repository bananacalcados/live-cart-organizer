...
BEGIN
  ...
  results AS (
    SELECT
      ...
      COALESCE(l.is_mass_dispatch, false) AS last_is_mass_dispatch
    FROM latest l
...
END;
$function$;
GRANT EXECUTE ON FUNCTION public.get_conversations(uuid, boolean) TO authenticated, anon, service_role;