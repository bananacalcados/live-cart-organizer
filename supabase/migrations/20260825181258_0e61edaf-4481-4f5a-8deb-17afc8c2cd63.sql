...
BEGIN
  ...
  IF NEW.type = 'withdraw' THEN
    INSERT INTO public.cash_flow_entries (store_id, entry_date, direction, amount, category_id, bank_account_id, description, source, source_ref_id, is_transfer, transfer_pair_id, status, confidence, ledger, metadata)
