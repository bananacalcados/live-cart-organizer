...
BEGIN
  ...
  LOOP
    ...
    -- Blindagem contra reprocessamento: índice parcial exige WHERE explícito no ON CONFLICT.
    v_adj_id := NULL;
    ...
    ON CONFLICT (sale_id, product_id, sale_event) WHERE (sale_id IS NOT NULL) DO NOTHING
