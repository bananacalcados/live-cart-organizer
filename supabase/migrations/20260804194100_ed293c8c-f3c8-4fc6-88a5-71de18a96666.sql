...
ALTER TABLE public.pos_sales
  ADD COLUMN IF NOT EXISTS expedition_deleted_by uuid,
  ADD COLUMN IF NOT EXISTS expedition_deleted_at timestamptz,
  ADD COLUMN IF NOT EXISTS expedition_deleted_by_email text;
