...
BEGIN
  ...
  -- Última compra EFETIVA: cruza o agregado (last_purchase_at) com as vendas
  -- reais recentes do PDV/Live que ainda podem não ter sido consolidadas.
  -- Só é calculado quando algum filtro de última compra está em uso.
